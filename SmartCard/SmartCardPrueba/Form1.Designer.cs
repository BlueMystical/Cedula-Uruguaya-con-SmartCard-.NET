namespace SmartCardPrueba
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label2.Text = "Coloque una Tarjeta Sobre el Lector.";
			// 
			// listBox1
			// 
			...
			this.listBox1.Size = new System.Drawing.Size(567, 173);
			...
			this.button1.Text = "Leer Cedula Electronica Urugaya";
			...
			this.Name = "Form1";
			this.Text = "SmartCardTest (.NET Framework 4.0)";
